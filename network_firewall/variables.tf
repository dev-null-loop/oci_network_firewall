...
variable "nat_configuration" {
  description = "(Optional) (Updatable) Request to configure Network Address Translation (NAT) on a firewall."
  type = object({
...
variable "shape" {
  description = "(Optional) (Updatable) The shape of a firewall to determine the bandwidth that the firewall allows."
  type        = string
  default     = null
}
